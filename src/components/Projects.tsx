    ...
    <section id="projects" className="py-32 bg-slate-50 dark:bg-[#0A0F1F] relative overflow-hidden border-y border-slate-100 dark:border-white/5 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          <FadeIn>
            <p className="text-xs tracking-[0.25em] font-semibold text-sky-600 uppercase mb-4">
              Showcase
            </p>
          </FadeIn>
          <FadeIn delay={0.1}>
          ...
          <FadeIn delay={0.2}>
            <p className="text-sm md:text-base text-slate-500 font-medium mt-4 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
          {projectsData.map((project, idx) => (
            <FadeIn key={project.id} delay={0.3 + (idx * 0.1)} yOffset={30} duration={0.6}>
